...
public class mDNIeAccessibility extends ListPreference implements OnPreferenceChangeListener {
    ...
    /**
     * Restore mdnie "accessibility" setting from SharedPreferences. (Write to kernel.)
    ...
    public static void restore(Context context) {
        ...
        Utils.writeValue(FILE, sharedPrefs.getString(DeviceSettings.KEY_MDNIE_ACCESSIBILITY, "0"));
    }
